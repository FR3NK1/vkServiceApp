//
//  vkServicesAppUITests.swift
//  vkServicesAppUITests
//
...
class vkServicesAppUITests: XCTestCase {
    ...
    func testDidSelectAtRow() {
        ...
        app.tables.staticTexts["ВКонтакте"].tap()
        ...
        XCTAssertEqual(safari.textFields["URL"].value  as! String, "https://m.vk.com")
    }
}
